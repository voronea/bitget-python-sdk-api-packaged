...
class AccountApi(Client):
    def __init__(self, api_key, api_secret_key, passphrase, use_server_time=False, first=False, referral_id='', timeout=60):
        Client.__init__(self, api_key, api_secret_key, passphrase, use_server_time, first, referral_id, timeout)
    ...
    def setAssetMode(self, params):
        return self._request_with_params(POST, '/api/v2/mix/account/set-asset-mode', params)
    ...
    def bill(self, params):
        return self._request_with_params(GET, '/api/v2/mix/account/bill', params)
    ...
    def traderConfigQueryFollowers(self, params):
        return self._request_with_params(GET, '/api/v2/copy/mix-trader/config-query-followers', params)
